...
<html>
    <head>
        ...
        <title>Phyramid | @yield('title')</title>
    ...
    <body class="hold-transition skin-blue sidebar-mini">
        <div class="wrapper">
            ...
            <header class="main-header">
                <!-- Logo -->
                <a href="" class="logo" style="background-color:#0097a7 ">
                    <!-- mini logo for sidebar mini 50x50 pixels -->
                    <span class="logo-mini"><b>A</b>LT</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg"><b>Phyramid</b></span>
                </a>
                <!-- Header Navbar: style can be found in header.less -->
                <nav class="navbar navbar-static-top card-1 " style=" background-color:white">
                    <!-- Sidebar toggle button-->
                    <a href="#" class="sidebar-toggle" style="color:#000" data-toggle="push-menu" role="button">
