...
<section class="content">
    ...
    <div class="row">
                        ...
                        <form class="form-horizontal">
                            <div class="box-body">
                                <div class="form-group">
                                    <label for="inputEmail3" class="col-sm-4 control-label">Member NIC :</label>
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-4 control-label">Tracking Center</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label for="inputPassword3" class="col-sm-4 control-label">Side</label>
                                    <div class="col-sm-8">
                                        <select class="form-control" id="sel1">
                                            <option>1</option>
                                            <option>2</option>
            ...
            <div class="box box-info">
                ...
                <div class="box-body form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <img src="{{asset('')}}{{$member->image}}" alt="awaweaaw" width="110px">
                        </div>
                    </div>
                    <div class="form-group">
        ...
        <!--        <div class="col-md-6">
                    <img src="{{asset('')}}{{$member->image}}" alt="awaweaaw" width="150px">
                    <p style="">Introducer Image</p>
                </div>-->
        <div class="col-md-6">
